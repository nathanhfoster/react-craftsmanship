...
const isEqual = (nextSelection, prevSelection) => {
  const { shouldMemoizeInputFields: prevShouldMemoizeInputFields, renderInputs: prevRenderInputs } =
    prevSelection

  const { shouldMemoizeInputFields: nextShouldMemoizeInputFields, renderInputs: nextRenderInputs } =
    nextSelection
